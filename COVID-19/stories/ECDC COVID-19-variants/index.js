	...
	**/
	...
	ixmaps.htmlgui_onDrawTheme = function(szId){ 
		...
		if ( ixmaps.embeddedApi.embeddedApi.legend.url && ixmaps.embeddedApi.embeddedApi.legend.url.length){
			var li = (lastClicked.parent());
			if ( !$(li).find("div.external-legend")[0] ) {
				$(li).append("<div class='external-legend' style='min-height:2em'>"+ixmaps.embeddedApi.embeddedApi.legend.url+"</div>");
			}
			ixmaps.lastLegendTheme = szId;
		}
