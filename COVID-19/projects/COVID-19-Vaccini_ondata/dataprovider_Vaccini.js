...
(function () {
    ...
    ixmaps.VACCINI_SOMMINISTRAZIONI_LAST = function (theme,options) {
		...
		var myfeed = Data.feed({"source":szUrl,"type":"csv"}).load(function(mydata){
			...
			var szDate = new Date(columns[last]).toLocaleDateString();
			theme.szSnippet = "aggiornato al "+szDate;
			ixmaps.setTitle("<f2 style='color:#888888;background-color:rgba(255,255,255,0.1);padding:0.3em 0.5em;border:#888888 solid 0.5px;border-radius:0.2em'>aggiornato: "+(szDate)+"</f2>");
    ...
    ixmaps.VACCINI_SOMMINISTRAZIONI_LAST_ALT = function (theme,options) {
     ...
     ixmaps.VACCINI_PERCENTUALI_LAST = function (theme,options) {
		...
		var myfeed = Data.feed({"source":szUrl,"type":"csv"}).load(function(mydata){
			...
			var pivot = __get_percentuali(mydata,options);
    ...
    ixmaps.VACCINI_PERCENTUALI_LAST_ALT = function (theme,options) {
		ixmaps.VACCINI_PERCENTUALI_LAST(theme,options);
	}
