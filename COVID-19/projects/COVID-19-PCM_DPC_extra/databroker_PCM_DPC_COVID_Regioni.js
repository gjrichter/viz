		...
		var broker = new Data.Broker()
			...
			**/
			...
			merger.realize(function (dbTable) {
				...
				for ( var i =0; i<columnsA.length; i++ ){
					if (columnsA[i] == "1/3/2020"){
					  szXaxisA.push("Mar");
					}else
					if (columnsA[i] == "1/4/2020"){
					  szXaxisA.push("Apr");
					}else
					if (columnsA[i] == "1/5/2020"){
					  szXaxisA.push("Mag");
					}else
					if (columnsA[i] == "1/6/2020"){
					  szXaxisA.push("Giu");
					}else
					if (columnsA[i] == "1/7/2020"){
					  szXaxisA.push("Lug");
					}else
					if (columnsA[i] == "1/8/2020"){
					  szXaxisA.push("Aug");
					}else
					if (columnsA[i] == "1/9/2020"){
					  szXaxisA.push("Sep");
					}else
					if (columnsA[i] == "1/10/2020"){
					  szXaxisA.push("Ott");
					}else
					if (columnsA[i] == "1/11/2020"){
					  szXaxisA.push("Nov");
					}else
					if (columnsA[i] == "1/12/2020"){
					  szXaxisA.push("Dec");
					}else{
					  szXaxisA.push(" ");
					}
