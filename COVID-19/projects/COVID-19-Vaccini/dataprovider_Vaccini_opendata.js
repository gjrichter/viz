...
(function () {
	...
	ixmaps.VACCINI_PERCENTUALI_POPOLAZIONE_LAST = function (theme,options,column) {
		...
		var broker = new Data.Broker()
			...
			var iValue = mydata.column("seconda_dose").index;
	...
	ixmaps.VACCINI_PERCENTUALI_POPOLAZIONE_COLUMNS_SEQUENCE = function (theme, options, columns, flag) {
	...
	ixmaps.VACCINI_SOMMINISTRAZIONI_PRIMA_SECONDA_PERCENTUALI_POPOLAZIONE_SEQUENCE_MEAN_3 = function (theme, options) {
		return ixmaps.VACCINI_PERCENTUALI_POPOLAZIONE_COLUMNS_SEQUENCE(theme, options, ["prima_dose","seconda_dose"], "mean3");
	};
	ixmaps.VACCINI_SOMMINISTRAZIONI_PRIMA_SECONDA_PERCENTUALI_POPOLAZIONE_SEQUENCE_REVERS_MEAN_3 = function (theme, options) {
		return ixmaps.VACCINI_PERCENTUALI_POPOLAZIONE_COLUMNS_SEQUENCE(theme, options, ["seconda_dose","prima_dose"], "mean3");
	};
	...
	ixmaps.VACCINI_SOMMINISTRAZIONI_PRIMA_SECONDA_POPOLAZIONE_SEQUENCE_MEAN_3 = function (theme, options) {
		return ixmaps.VACCINI_POPOLAZIONE_COLUMNS_SEQUENCE(theme, options, ["prima_dose","seconda_dose"], "mean3");
	};
    ...
    ixmaps.VACCINI_PERCENTUALI_POPOLAZIONE_SEQUENCE = function (theme,options,valueColumnName) {
		...
		var broker = new Data.Broker()
			...
			var dte = new Date(columns[columns.length-1]);
			xAxis[columns.length-1]=(dte.toLocaleDateString());
			var dte = new Date(columns[0]);
			xAxis[0]=(dte.toLocaleDateString());
			options.theme.szXaxisA = xAxis; 
