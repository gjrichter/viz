...
(function () {
	...
	ixmaps.data.makeItemList = function (szFilter,szDiv) {
		...
		// theme
		// ------------------------------------
		var objThemeDefinition = ixmaps.getThemeDefinitionObj("progetti");
		var objTheme = ixmaps.getThemeObj("progetti");
		...
		for ( i in objTheme.indexA ){
			...
			szHtml += "<div style='margin:0.5em 0 0 0.5em;'>"+(Number(i)+1)+"</div>";
