...
(function () {
    ...
    ixmaps.__bestFormatValue = function (nValue) {
        if (nValue >= 10) {
            return ixmaps.__formatValue(nValue, 0, "POINT");
        } else
        if (nValue >= 1) {
            return ixmaps.__formatValue(nValue, 1, "POINT");
        } else {
            return ixmaps.__formatValue(nValue, 2, "POINT");
        }
    };
    ...
    ixmaps.legend.makeColorLegendHTMLLong = function (szId, szLegendId, szMode) {
        ...
        if (nSumCount && !themeObj.szFlag.match(/BAR/) && !(ixmaps.layout == "minimal") ){
            var szSum = ixmaps.__formatValue(nSumCount,nDecimals,"POINT") + " " + (!themeObj.szFlag.match(/COUNT/)?(themeObj.szLegendUnits||themeObj.szUnits||""):"");
        ...
        if (fColorScheme &&
            ...
            for (var i = 0; i < nRows; i++) {
                ...
                // show class count
                var szCount = ixmaps.__formatValue(sortA[i].count, nDecimals, "POINT") + (themeObj.szFlag.match(/COUNT/) ? "" : (" " + szUnit));
                ...
                if (themeObj.szFlag.match(/SIMPLELEGEND|COMPACTLEGEND/)) {
					...
					if ( themeObj.szFlag.match(/CHART/) ){
						if ((colorA[sortA[i].color] == "none") || (themeObj.szLineColor && themeObj.nLineWidth)) {
							if (themeObj.fillOpacity < 0.1) {
								szHtml += "<span style='background:none;border:solid " + themeObj.szLineColor + " 1px;opacity:0.7;font-size:1em;border-radius:0 1em 1em 0;margin-right:1em;'>";
							} else 
							if ( themeObj.szFlag.match(/BAR/) ){
								...
								**/
								szHtml += "<span style='background:" + colorA[sortA[i].color] + ";border:solid " + themeObj.szLineColor + " 1px;opacity:0.7;font-size:1em;border-radius:0 1em 1em 0;margin-right:1em;'>";
							}
						} else {
							if ( themeObj.szFlag.match(/BAR/) && themeObj.szFlag.match(/POINTER/) ){
								...
								szHtml += "<span style='background:" + (themeObj.szLineColor||colorA[sortA[i].color]) + ";opacity:0.7;font-size:1em;border-radius:0 1em 1em 0;margin-right:1em;'>";
							}
						}
					}else{
                    ...
                    var szValue = sortA[i].count?(""+ixmaps.__formatValue(sortA[i].count, nDecimals, "POINT")+""):"";
                    ...
                    if (sortA[i].count) {
                        szHtml += "<span class='theme-legend-count' style='font-size:1em;'>&nbsp;&nbsp;" + szValue + "" + szUnit + "</span>";
                    } else
                    if (themeObj.szLabelA && !themeObj.szFlag.match(/SIMPLELEGEND/) && !(ixmaps.layout == "minimal") ) {
                        if ((typeof (themeObj.nMinA[i]) != "undefined") &&
                            ...
                            if (themeObj.nMeanA[i]) {
                                szHtml += "<span style='font-size:1em;float:right;padding-left:10px' title='mean value'>" + ixmaps.__formatValue(themeObj.nMeanA[i], nDecimals, "POINT") + "" + szUnit+ "</span>";
                            }
                        } else
                        if ((typeof (themeObj.nOrigMinA[i]) != "undefined") &&
                            (typeof (themeObj.nOrigMaxA[i]) != "undefined") &&
                            (themeObj.nOrigMinA[i] < themeObj.nOrigMaxA[i])) {
                            szHtml += "<span style='padding-left:10px'>" + ixmaps.__formatValue(themeObj.nOrigMinA[i], nDecimals, "POINT") + " " + szUnit + "</span>  ... <span style='padding-left:5px'>" + ixmaps.__formatValue(themeObj.nOrigMaxA[i], nDecimals, "POINT") + " " + szUnit + "</span>";
                        } else
                        if ((typeof (themeObj.partsA[i].min) != "undefined") && (typeof (themeObj.partsA[i].max) != "undefined")) {
                            szHtml += "<span style='padding-left:10px'>" + ixmaps.__formatValue(themeObj.partsA[i].min, nDecimals, "POINT") + " " + szUnit + "</span>  ... <span style='padding-left:5px'>" + ixmaps.__formatValue(themeObj.partsA[i].max, nDecimals, "POINT") + " " + szUnit + "</span>";
                        } else {
                    ...
                    if (themeObj.szLabelA) {
                        if ((typeof (themeObj.nMinA[i]) != "undefined") &&
                            (typeof (themeObj.nMaxA[i]) != "undefined") &&
                            (themeObj.nMinA[i] < themeObj.nMaxA[i])) {
                            szHtml += "<span style='padding-left:10px'>" + ixmaps.__formatValue(themeObj.nMinA[i], nDecimals, "POINT") + " " + szUnit + "</span>  ... <span style='padding-left:5px'>" + ixmaps.__formatValue(themeObj.nMaxA[i], nDecimals, "POINT") + " " + szUnit + "</span>";
                            if (themeObj.nMeanA[i]) {
                        ...
                        if ((typeof (themeObj.partsA[i].min) != "undefined") && (typeof (themeObj.partsA[i].max) != "undefined")) {
                            szHtml += "<span style='padding-left:10px'>" + ixmaps.__formatValue(themeObj.partsA[i].min, nDecimals, "POINT") + " " + szUnit + "</span>  ... <span style='padding-left:5px'>" + ixmaps.__formatValue(themeObj.partsA[i].max, 2, "POINT") + " " + szUnit + "</span>";
                        } else {
                            console.log(themeObj);
                        }
                    }
            ...
            if (((themeObj.nMinValue || themeObj.nMin) != 1) || ((themeObj.nMaxValue || themeObj.nMax) != 1)) {
				...
				if ( (themeObj.szFlag.match(/VECTOR/) || themeObj.szFlag.match(/BEZIER/)) ){
					szHtml += "<tr valign='top'><td><span onclick='javascript:ixmaps.hideThemeClass(\"" + szId + "\"," + 0 + ")'  style='background:" + colorA[0] + ";font-size:0.5em;vertical-align:10%;border-radius:1em;opacity:"+opacity+";width:30px'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td><td><span style='padding-left:0.5em'>" + ixmaps.__formatValue((themeObj.nMinValue || themeObj.nMin), nDecimals, "POINT") + " " + ((szUnit.length < 5) ? szUnit : "") + "</span></td><td> ...</td><td><span style='padding-left:5px'>" + ixmaps.__formatValue((themeObj.nMaxValue || themeObj.nMax), nDecimals, "POINT") + " " + szUnit + "</span></td></tr>";
				}else{
					szHtml += "<tr valign='top'><td><span onclick='javascript:ixmaps.hideThemeClass(\"" + szId + "\"," + 0 + ")'  style='background:" + colorA[0] + ";font-size:1em;border-radius:1em;opacity:"+opacity+";'>&nbsp;&nbsp;</span></td><td><span style='padding-left:0.5em'>" + ixmaps.__formatValue((themeObj.nMinValue || themeObj.nMin), nDecimals, "POINT") + " " + ((szUnit.length < 5) ? szUnit : "") + "</span></td><td> ...</td><td><span style='padding-left:5px'>" + ixmaps.__formatValue((themeObj.nMaxValue || themeObj.nMax), nDecimals, "POINT") + " " + szUnit + "</span></td></tr>";
				}
            } else {
    ...
    ixmaps.legend.makeColorLegendHTMLCompact = function (szId, szLegendId) {
        ...
        szHtml += "<td colspan='" + (span) + "' >" + ixmaps.__formatValue(nMin, nDecimals, "POINT") + szUnit + "</td>";
        szHtml += "<td colspan='" + (nColors - span) + "' align='right'>" + ixmaps.__formatValue(nMax, nDecimals, "POINT") + ((szUnit.length <= 3) ? szUnit : "") + "</td>";
        szHtml += "</tr>";
    ...
    ixmaps.legend.makeLegendHTML = function (szLegendId) {
        ...
        szHtml += "min: " + ixmaps.__formatValue((ixmaps.themeObj.nMin), 2, "POINT") + "<br>";
        szHtml += "max: " + ixmaps.__formatValue((ixmaps.themeObj.nMax), 2, "POINT");
        szHtml += "</p>";
        szHtml += "</div>"
