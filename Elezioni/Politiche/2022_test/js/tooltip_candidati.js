	...
	ixmaps.htmlgui_onItemOver = function (evt,szId) {
		...
		var suffix = "";
					...
					if (data) {
						...
						for ( a in data){
							if(data[a].sesso=='F'){
								szHtml += "<tr style='background:#fff8f8'><td style='width:350px'>"+data[a].nome_c+" "+data[a].cogn_c+"</td><td>"+data[a].eta+" anni</td></tr><tr><td style='font-size:0.6em;width:350px'>"+data[a].coalizione+"</td><tr>";
								eta += data[a].eta;
							}
						}
						for ( a in data){
							if(data[a].sesso=='M'){
								szHtml += "<tr style='background:#f8f8ff'><td style='width:350px'>"+data[a].nome_c+" "+data[a].cogn_c+"</td><td>"+data[a].eta+" anni</td></tr><tr><td style='font-size:0.6em;width:350px'>"+data[a].coalizione+"</td><tr>";
								eta += data[a].eta;
							}
						}
						...
						szHtml += "<section>";
						szHtml += "<div style='margin:1em 1em 1em 1em'><h4>"+data.length+" candidati, età media: "+Math.floor(eta/data.length*10)/10+"<h4></div>"
						szHtml += "<div style='height:0.1em'></div>"
						szHtml += "</section>";
