...
il progetto (json) per la mappa si trovano <a href="https://github.com/gjrichter/viz/tree/master/Amministratori/ixmaps_project_ammcom_pointer_offsetmean.json" target="_blank">qui</a>, 
sotto il codice per includere la mappa in una pagina HTML:
